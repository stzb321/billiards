...
namespace RuntimeInspectorNamespace
{
	...
	public class NumberHandlers
	{
		...
		private class IntHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { int parsedVal; bool result = int.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class UIntHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { uint parsedVal; bool result = uint.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class LongHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { long parsedVal; bool result = long.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class ULongHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { ulong parsedVal; bool result = ulong.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class ByteHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { byte parsedVal; bool result = byte.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class SByteHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { sbyte parsedVal; bool result = sbyte.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class ShortHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { short parsedVal; bool result = short.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class UShortHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { ushort parsedVal; bool result = ushort.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class FloatHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { float parsedVal; bool result = float.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class DoubleHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { double parsedVal; bool result = double.TryParse( input, out parsedVal ); value = parsedVal; return result; }
		...
		private class DecimalHandler : INumberHandler
		{
			...
			public bool TryParse( string input, out object value ) { decimal parsedVal; bool result = decimal.TryParse( input, out parsedVal ); value = parsedVal; return result; }
